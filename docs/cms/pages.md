...
* Если настройки не заданы, по умолчанию константа указывает путь расположения файла страницы.
...
* Столбец “Маска” отображает, на каких страницах/блоках используется данный слой.
