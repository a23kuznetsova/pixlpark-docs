...
* Но для доменов в панели регистратора (например, nic.ru) предварительно должна быть создана запись типа __А__ с IP-адресом 188.40.16.220, либо задан список требуемых NS-серверов:
    + ns1.gcorelabs.net
    + ns2.gcdn.services
