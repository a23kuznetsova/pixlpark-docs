...
* Но для доменов в панели регистратора (например, nic.ru) предварительно должна быть создана запись типа __А__ с IP-адресом, либо задан список требуемых NS-серверов:
    + ns1.gcorelabs.net
    + ns2.gcdn.services
* Выполняя смену NS-серверов, предварительно сообщите свой домен в техническую поддержку Pixlpark.
